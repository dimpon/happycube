...
rem java  -jar ./target/happycube-spring-boot.jar ./data blue txt ./solutions/blue solution sol false true

java  -jar ./target/happycube-spring-boot.jar ./data red txt ./solutions/red solution sol true true
